...
# # print(allDrivers)
>>>>>>> parent of da40c77 (update driver database to class database):website/driverDb.py
=======
        self.conn.commit()
>>>>>>> parent of 26f1d3a (Rename driverDb.py to driverdb.py):website/driverDb.py
